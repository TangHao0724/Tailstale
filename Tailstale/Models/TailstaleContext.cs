...
public partial class TailstaleContext : DbContext
{
    ...
    public virtual DbSet<myChoice> myChoices { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Appointment_ID).HasName("PK__Appointm__FD01B5036A306212");
        ...
        {
            entity.HasKey(e => e.id).HasName("PK__Beautici__3213E83FC8BDF17E");
        ...
        {
            entity.HasKey(e => e.bookingID).HasName("PK__Booking__C6D03BEDFEDC63F6");
        ...
        {
            entity.HasKey(e => e.bdID).HasName("PK__BookingD__4E75390F80BE9780");
        ...
        {
            entity.HasKey(e => e.id).HasName("PK__Business__3213E83FBFDEB26B");
        ...
        {
            entity.HasKey(e => e.checkinID).HasName("PK__CheckinD__CF1A6A41566FAD8B");
        ...
        {
            entity.HasKey(e => e.id).HasName("PK__Consumpt__3213E83F046F58AC");
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__Message__3214EC27A1D40BE5");
        ...
        {
            entity.HasKey(e => e.paymentID).HasName("PK__PaymentI__A0D9EFA6599695BC");
        ...
        {
            entity.HasKey(e => e.id).HasName("PK__Reserve__3213E83F01C9FCC9");
        ...
        {
            entity.HasKey(e => e.reviewID).HasName("PK__Review__2ECD6E248080BAD0");
        ...
        {
            entity.HasKey(e => e.roomID).HasName("PK__Rooms__6C3BF5DE2325EDE6");
        ...
        {
            entity.HasKey(e => e.id).HasName("PK__Service__3213E83F21CB8428");
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__article__3214EC27524D7DE1");
        ...
        {
            entity.HasKey(e => e.id).HasName("PK__biologic__3213E83FB2368D05");
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__business__3214EC272315A624");
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__business__3214EC270F09F9FE");
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__business__3214EC277D50524D");
        ...
        {
            entity.HasKey(e => e.business_type_ID).HasName("PK__business__2F9BFA518982C74D");
        ...
        {
            entity.HasKey(e => e.daily_outpatient_clinic_schedule_ID).HasName("PK__daily_ou__A98BAD4EC42AEE5B");
        ...
        {
            entity.HasKey(e => e.department_ID).HasName("PK__departme__C22220EAB7F9D175");
        ...
        {
            entity.HasKey(e => e.id).HasName("PK__dosage_f__3213E83FCA7F1895");
        ...
        {
            entity.HasKey(e => e.id).HasName("PK__frequenc__3213E83F8252DA2E");
        ...
        {
            entity.HasKey(e => e.id).HasName("PK__hosp_his__3213E83FDD1988BF");
        ...
        {
            entity.HasKey(e => e.image_id).HasName("PK__image_fi__DC9AC95595FF9072");
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__keeper__3214EC270FFE89E0");
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__keeper_i__3214EC278B6BB70A");
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__keeper_i__3214EC27A313725B");
        ...
        {
            entity.HasKey(e => e.id).HasName("PK__medical___3213E83F95A81F49");
        ...
        {
            entity.HasKey(e => e.id).HasName("PK__medical___3213E83FBD9FDA91");
        ...
        {
            entity.HasKey(e => e.id).HasName("PK__medicine__3213E83FFF5C7AB9");
        ...
        {
            entity.HasKey(e => e.id).HasName("PK__medicine__3213E83F39422110");
        ...
        {
            entity.HasKey(e => e.id).HasName("PK__medicine__3213E83FFAE87BE1");
        ...
        {
            entity.HasKey(e => e.member_status_ID).HasName("PK__member_s__819644FE5DAF8A48");
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__memo__3214EC27D4EBED35");
        ...
        modelBuilder.Entity<myChoice>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("myChoice");
        ...
        {
            entity.HasKey(e => e.id).HasName("PK__nursing___3213E83FF5E64CDD");
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__order_st__3214EC27EBFF2A01");
        ...
        {
            entity.HasKey(e => e.outpatient_clinic_ID).HasName("PK__outpatie__6AA2EF947667FC2D");
        ...
        {
            entity.HasKey(e => e.outpatient_clinic_timeslot_ID).HasName("PK__outpatie__C88688B9B9F23BCE");
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__person_t__3214EC278011F9EC");
        ...
        {
            entity.HasKey(e => e.pet_ID).HasName("PK__pet__3913D1664A26ACFA");
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__pet_type__3214EC27F017E13F");
        ...
        {
            entity.HasKey(e => e.id).HasName("PK__record_t__3213E83F9E4CA44E");
        ...
        {
            entity.HasKey(e => e.roomType_ID).HasName("PK__roomType__28045B8820573C38");
        ...
        {
            entity.HasKey(e => e.id).HasName("PK__specimen__3213E83F0A86412F");
        ...
        {
            entity.HasKey(e => e.id).HasName("PK__surgery__3213E83FAC475F6F");
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__tags__3214EC27A61024FD");
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__using_pe__3214EC27FB90B6F9");
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__using_ta__3214EC2741645B32");
        ...
        {
            entity.HasKey(e => e.vet_ID).HasName("PK__vet_info__D816DB2B5B645F1C");
        ...
        {
            entity.HasKey(e => e.id).HasName("PK__vital_si__3213E83FCC5BC38A");
        ...
        {
            entity.HasKey(e => e.ward_ID).HasName("PK__ward__396CB5D5227CD56E");
